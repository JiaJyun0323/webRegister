...
<body>
	...
	<form action="newmessage.php" method="post">
		<div class="card">
			<h5 class="card-header">new a message</h5>
			<div class="card-body">
