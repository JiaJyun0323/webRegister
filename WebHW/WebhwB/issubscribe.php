...
<body>
    <h1 style="text-align:center">is subscribe</h1>

	<div class="text-center">
		<form action="checksub.php" method="post">
        	<input class="btn btn-outline-danger"type="submit" name="subscribe" value="unsubscribe"></input>
    	</form>
  		<img src="01.jpg" class="rounded" />
	</div>
